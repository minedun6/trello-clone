        ...
        <div class="flex px-1 py-2 bg-blue-dark items-center justify-between">
            ...
            <div class="mx-0">
                <a href="#" class="no-underline">
                    <span class="flex">
                        <h1 class="text-blue-lighter text-xl flex items-center font-sans italic justify-between hover:text-white" v-if="!loading">
                            <svg class="fill-current h-8 mr-1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 50 50"><path
                                    d="M41 4H9C6.24 4 4 6.24 4 9v32c0 2.76 2.24 5 5 5h32c2.76 0 5-2.24 5-5V9c0-2.76-2.24-5-5-5zM21 36c0 1.1-.9 2-2 2h-7c-1.1 0-2-.9-2-2V12c0-1.1.9-2 2-2h7c1.1 0 2 .9 2 2v24zm19-12c0 1.1-.9 2-2 2h-7c-1.1 0-2-.9-2-2V12c0-1.1.9-2 2-2h7c1.1 0 2 .9 2 2v12z"/></svg>
                            Trello
                        </h1>
