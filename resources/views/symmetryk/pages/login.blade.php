...
<head>
    ...
    <link href="{{ mix('/symmetryk/css/app.css') }}" rel="stylesheet">
</head>
<body class="bg-grey-lighter text-base text-grey-darkest font-normal relative font-sans">
<div class="h-2 bg-primary"></div>

<div class="container mx-auto p-8">
        <div class="mx-auto max-w-sm">
            <div class="py-10 text-center">
                @include('symmetryk.pages.logo', ['style' => 'max-width: 16rem;'])
            </div>
            <div class="bg-white rounded shadow">
                ...
                <form class="bg-grey-lightest px-10 py-10">
                    ...
                    <div class="mb-3">
                        <input class="border w-full p-3" name="email" type="text" placeholder="E-mail Address">
                    </div>
                    <div class="mb-6">
